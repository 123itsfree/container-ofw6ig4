...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-ofw6ig4.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-ofw6ig4.containers.anotherwebservice.com/
...
```
git clone git@github.com:123itsfree/container-ofw6ig4.git
cd container-ofw6ig4
```
...
```
docker attach container-ofw6ig4
```
